...
%% Reading both the images % left image    % right image
 a = im2double(imread(fullfile('input', 'pair1-L.png')));
 a1 = im2double(imread(fullfile('input', 'pair1-R.png')));
...
close(fw)                                          %Normalizing the output image

%% Showing the output
figure;
subplot(1,2,1)
imagesc(out);                                            % Displaying the images
subplot(1,2,2)
imshow(a);
